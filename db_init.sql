...
insert into supported_devices(device_id, device, build_id, check_property_name, check_property_value) values(189, 'LGL23', 'JDQ39B', 'ro.lge.swversion', 'LGL2310d');
  insert into device_address(device_id, name, value) values(189, 'prepare_kernel_cred', 3222023768);
  insert into device_address(device_id, name, value) values(189, 'commit_creds', 3222022476);
  insert into device_address(device_id, name, value) values(189, 'remap_pfn_range', 3222553300);
  insert into device_address(device_id, name, value) values(189, 'vmalloc_exec', 3222608016);
  insert into device_address(device_id, name, value) values(189, 'ptmx_fops', 3239181216);


insert into supported_devices(device_id, device, build_id, check_property_name, check_property_value) values(190, 'LGL22', 'JDQ39B', 'ro.lge.swversion', 'LGL2210b');
  insert into device_address(device_id, name, value) values(190, 'prepare_kernel_cred', 3222026972);
  insert into device_address(device_id, name, value) values(190, 'commit_creds', 3222025680);
...
insert into supported_devices(device_id, device, build_id, check_property_name, check_property_value) values(191, 'L01F', 'JDQ39B', 'ro.lge.swversion', 'L01F11k');
  insert into device_address(device_id, name, value) values(191, 'prepare_kernel_cred', 3222026152);
...
insert into supported_devices(device_id, device, build_id, check_property_name, check_property_value) values(193, 'HTL21', 'JRO03C', 'ro.aa.romver', '1.39.970.3');
  insert into device_address(device_id, name, value) values(193, 'prepare_kernel_cred', 3221929644);
  insert into device_address(device_id, name, value) values(193, 'commit_creds', 3221928344);
  insert into device_address(device_id, name, value) values(193, 'remap_pfn_range', 3222272008);
  insert into device_address(device_id, name, value) values(193, 'vmalloc_exec', 3222322180);
  insert into device_address(device_id, name, value) values(193, 'ptmx_fops', 3234979652);
